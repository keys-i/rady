...
| Hosted mention replies | `RADY_GEMINI_PRIVATE_OK=true`, `RADY_XAI_PRIVATE_OK=true` for private-repository provider opt-in | `RADY_GEMINI_API_KEY`, `RADY_CEREBRAS_API_KEY`, optional `RADY_XAI_API_KEY` |
